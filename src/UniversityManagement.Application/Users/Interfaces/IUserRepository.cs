...
namespace UniversityManagement.Application.Users.Interfaces
{
    public interface IUserRepository : IRepository<User>
    {
        ...
        Task<bool> EnrollStudentInClassAsync(Guid studentId, Guid classId, Guid? assignedByUserId, CancellationToken cancellationToken);
        Task<bool> EnrollStudentInCourseAsync(Guid studentId, Guid courseId, Guid? assignedByUserId, CancellationToken cancellationToken);
